...
// Controller 
const { insertPhoto,deletePhoto,getAllPhotos, getUserPhotos,getPhotoById, updatePhoto, commentPhoto , likePhoto , searchPhotos } = require('../controllers/PhotoController')
// Middlewares
